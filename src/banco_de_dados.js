...
let pergunta10 = new Pergunta (programacao, "O que é escopo de uma variável em programação?", "a) O nome de uma variável", "b) O valor de uma variável", "c) A área do programa onde uma variável é válida e pode ser acessada" ,"d) O tipo de dado de uma variável", "c) A área do programa onde uma variável é válida e pode ser acessada")
